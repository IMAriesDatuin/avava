...
var hexagon = (function hexagon($, window, document, undefined) {
	...
	function init($element) {
		...
		//removeIf(production)
		get.info('hexagon', '1.0', 'Aries Datuin');
		...
		var hexagon_radius = 50,
			hexagon_max_absolute_speed = 0.02,
			hexagon_space_between = 2,
			hexagon_line_width = 1,
			hexagon_color = '#e1c389';
		...
		window.requestAnimFrame = (function(){
		  return  window.requestAnimationFrame ||
		          window.webkitRequestAnimationFramen||
