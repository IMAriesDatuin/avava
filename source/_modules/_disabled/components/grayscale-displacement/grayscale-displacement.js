...
var grayscaleDisplacement = (function grayScaleDisplacement($, window, document, undefined) {
    ...
    function init() {
        ...
        //removeIf(production)
        get.info('grayScaleDisplacement', '1.0', 'Aries Datuin');
        ...
        var params = {
          webGLCanvasID: 'grayscale-displacement-container',
          planeElementID: 'grayscale-displacement-plane',
        ...
        MouseEffect.prototype.handlePlane = function() {
            ...
            self.plane.onReady(function() {
                ...
                document.getElementById('nav-panel-particle-grid').addEventListener('mousemove', self.handleMovement.bind(self), false);
                document.getElementById('nav-panel-particle-grid').addEventListener('touchmove', self.handleMovement.bind(self), {
                    passive: true
                });
        ...
        MouseEffect.prototype.removePlane = function() {
            ...
            document.getElementById('nav-panel-particle-grid').removeEventListener('mousemove', self.handleMovement);
            document.getElementById('nav-panel-particle-grid').removeEventListener('touchmove', self.handleMovement);
        ...
        MouseEffect.prototype.addPlane = function() {
            ...
            this.planeParams = {
                vertexShaderID: 'grayscale-displacement-vs',
                fragmentShaderID: 'grayscale-displacement-fs',
                imageCover: true,
                uniforms: {
                    mousePosition: {
                        name: 'uMousePosition',
        ...
        function grayScaleDisplacementInit() {
